 ...
 */
public class GenerateSigHelper {
    ...
    public static String genUserSig(int sdkId,String userId,String secretKey) {
        return GenTLSSignature(sdkId, userId, EXPIRETIME, null, secretKey);
    }
